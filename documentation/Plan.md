...
6.	Оставить поле `Номер карты` пустым.

*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Обязательное поле".

7. Ввести в поле `Номер карты` 15 числовых символов.
   
*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Неверный формат".

8. Ввести в поле `Номер карты` случайный набор 16 числовых символов.
   
*Ожидаемый результат:* Данные отправляются. Появляется сообщение об отказе в операции. 

9. Ввести в поле `Номер карты` 17 числовых символов.
   
*Ожидаемый результат:* Ввод семнадцатого символа невозможен.

10. Ввести в поле `Номер карты` буквенные символы, спецсимволы
...
11.	Оставить поле `Месяц` пустым.

*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Обязательное поле".

12. Ввести в поле `Месяц` номер месяца 00.

*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Неверно указан срок действия карты".

13. Ввести в поле `Месяц` номер месяца 13.
   
*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Неверно указан срок действия карты".

14. Ввести в поле `Месяц` значение ранее текущего месяца.

*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Неверно указан срок действия карты" 

15. Ввести в поле `Месяц` одно числовое значение.
      
*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Неверный формат"

16. Ввести в поле `Месяц` 3 числовых значения.
      
*Ожидаемый результат:* Ввод третьего символа невозможен.

17. Ввести в поле `Месяц` буквенные символы, спецсимволы
...
18. Оставить поле `Год` пустым.

*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Обязательное поле".

19. Ввести в поле `Год` значение ранее текущего года.

*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Неверно указан срок действия карты".

20. Ввести в поле `Год` значение более 5 лет от текщего года.

*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Неверно указан срок действия карты".

21. Ввести в поле `Год` одно числовое значение.
      
*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Неверный формат"

22. Ввести в поле `Год` 3 числовых значения.
      
*Ожидаемый результат:* Ввод третьего символа невозможен.

23. Ввести в поле `Год` буквенные символы, спецсимволы.
...
24. Оставить поле `Владелец` пустым.

*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Обязательное поле".

25. Ввести в поле `Владелец` 1 латинский символ.

*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Неверный формат".

26. Ввести в поле `Владелец` 65 латинских символов.

*Ожидаемый результат:* Ввод свыше 64 символов  невозможен.

27. Ввести в поле `Владелец` символы на кириллице, числовые значения, спецсимволы.
...
28. Оставить поле `CVC/CVV` пустым.

*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Обязательное поле".

29. Ввести в поле `CVC/CVV` 1 числовой символ.

*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Неверный формат".

30. Ввести в поле `CVC/CVV` 4 числовых символов.

*Ожидаемый результат:* Ввод свыше 3 символов  невозможен.

31. Ввести в поле `CVC/CVV` 000.

*Ожидаемый результат:* Данные не отправляются. Поле подсвечивается, выводится текст "Неверный формат".

32. Ввести в поле `CVC/CVV` буквенные символы, спецсимволы
   
*Ожидаемый результат:* Ввод невозможен. Поле остается пустым, подсвечивается, выводится текст "Обязательное поле".

#### 33. Проверка на соответствие количества строк в СУБД MySQL отправленным данным:
1. Нажать на кнопку `Купить`. 
...
#### 34. Просмотр оплаты тура в СУБД MySQL зарегистрированного пользователя:
1. Нажать на кнопку `Купить`. 
2. Ввести в поле `Номер карты` одобренную карту 4444 4444 4444 4441.
3. Ввести в поля `Месяц`, `Год`, `Владелец`, `CVC/CVV` валидные данные в соответствии с требованиями.
4. Нажать на кнопку `Продолжить`.
...
#### 35. Просмотр оплаты тура в СУБД MySQL отклоненного пользователя:
1. Нажать на кнопку `Купить`. 
2. Ввести в поле `Номер карты` отклоненную карту 4444 4444 4444 4442.
3. Ввести в поля `Месяц`, `Год`, `Владелец`, `CVC/CVV` валидные данные в соответствии с требованиями.
4. Нажать на кнопку `Продолжить`.
...
#### 36. Проверка статуса на сервере одобренной карты. API-тест:
1. Нажать на кнопку `Купить`. 
...
#### 37. Проверка статуса на сервере отклоненной карты. API-тест:
1. Нажать на кнопку `Купить`. 
2. Ввести карту с данными:
...
#### 38. Проверка статуса на сервере карты cо случайным набором 16 числовых символов. API-тест:
1. Нажать на кнопку `Купить`. 
2. Ввести карту с данными:
